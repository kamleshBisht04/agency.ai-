...
const Hero = () => {
  return (
    ...
    >
      <div className="inline-flex items-center gap-2 border boreder-gray-300 p-1.5 pr-4 rounded-full ">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-[84px] font-medium xl:leading-[95px] max-w-5xl  ">
        ...
        <span className="bg-gradient-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent mr-4 ">
          digital
        </span>
        impact.
      </h1>
      ...
      <p className="text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3">
        Creating meaningful connectin and turning big ideas into interactive digital experiences.
      </p>

      <div className="relative">
        <img src={assets.hero_img} alt="hero image" className="w-ful max-w-6xl" />
        <img
          src={assets.bgImage1}
          alt="blur section"
